 ...
 */
@Entity
@DiscriminatorValue(value = "Unfollow")
public class UnfollowConfiguration extends AConfiguration {
    ...
    private Boolean unfollowUsers, unfollowBoards;
    
    private Boolean unfollowNonFollowers; // unfollow all who are not following us back.
    private Boolean unfollowOnlyRecordedFollowings; // unfollow only if PinBot has followed them + recorded timestmap when followed (in 'duplicates' field)
    private Long timeBetweenFollowAndUnfollow; //used with 'unfollowOnlyRecordedFollowings' to check how much time should be passed after following, before unfollowing them.

    public Boolean getUnfollowNonFollowers() {
        return unfollowNonFollowers;
    }

    public void setUnfollowNonFollowers(Boolean unfollowNonFollowers) {
        this.unfollowNonFollowers = unfollowNonFollowers;
    }

    public Boolean getUnfollowOnlyRecordedFollowings() {
        return unfollowOnlyRecordedFollowings;
    }

    public void setUnfollowOnlyRecordedFollowings(Boolean unfollowOnlyRecordedFollowings) {
        this.unfollowOnlyRecordedFollowings = unfollowOnlyRecordedFollowings;
    }

    public Long getTimeBetweenFollowAndUnfollow() {
        return timeBetweenFollowAndUnfollow;
    }

    public void setTimeBetweenFollowAndUnfollow(Long timeBetweenFollowAndUnfollow) {
        this.timeBetweenFollowAndUnfollow = timeBetweenFollowAndUnfollow;
    }
    ...
    public Boolean getUnfollowUsers() {
    ...
    public Boolean getUnfollowBoards() {
        return unfollowBoards;
    }

    public void setUnfollowBoards(Boolean unfollowBoards) {
        this.unfollowBoards = unfollowBoards;
    }
    ...
    public boolean equals(Object object) {
        if (!(object instanceof UnfollowConfiguration)) {
            return false;
        }
        UnfollowConfiguration other = (UnfollowConfiguration) object;
