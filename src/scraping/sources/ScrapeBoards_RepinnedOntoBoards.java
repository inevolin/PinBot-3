...
//previous type: RepinFeedResource
public class ScrapeBoards_RepinnedOntoBoards extends ScrapeBoards {

    String pinId;
    String aggregated_pin_data_id;

    public ScrapeBoards_RepinnedOntoBoards(Account account, AQuery query, AConfiguration config) throws Exception {
    ...
    protected String GetData() {
        try {
            String str;
            if (FirstRequest) {
                str = "/pin/" + pinId + "/activity/";
            } else {
                str = "/resource/AggregatedActivityFeedResource/get/"
                        + "?source_url="
    ...
    protected void Parse(String key, String value) {
        super.Parse("type", "repinactivity");
    ...
    protected Board createBoard() {
        return new Board(PinterestObject.PinterestObjectResources.RepinFeedResource, query);
    }
}
